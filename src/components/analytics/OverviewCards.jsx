...
const overviewData = [
  { name: "Revenue", value: "$1,234,5667", change: 12.5, icon: DollarSign },
  { name: "Users", value: "45,678", change: 8.5, icon: Users },
  ...
  return (
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
      {overviewData.map((item, index) => (
        <motion.div
          key={item.name}
          className="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-md rounded-xl p-6 border border-gray-700"
        ...
        >
          ...
          >
            ...
            <span className="ml-2 text-sm font-medium">{item.change}%</span>
